<script>
  ...
  $: gridStyle = {
    ...
    gridareas: [
      '"header header" "emphasis emphasis"',
      '"header header" "emphasis emphasis"',
      '"header header" "emphasis emphasis"',
    ],
  }
...
<Grid container style={gridStyle} {ssr}>
  <Heading as="h1" style={headerStyle} {ssr}>Take Care & Stay Aware</Heading>
  <Card {theme} style={emphasisCard}>
    <CardBody>
